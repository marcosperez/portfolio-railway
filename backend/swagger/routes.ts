...
import { expressAuthentication } from './../src/contexts/shared/infrastructure/middleware/authentication';
...
const models: TsoaRoute.Models = {
    ...
    "PageData_UserDTO_": {
        "dataType": "refObject",
        "properties": {
            "list": {"dataType":"array","array":{"dataType":"refObject","ref":"UserDTO"},"required":true},
    ...
    "ValidationError": {
        "dataType": "refObject",
        "properties": {
            "name": {"dataType":"enum","enums":["ValidationError"],"required":true},
            "message": {"dataType":"string","required":true},
            "stack": {"dataType":"string"},
            "isJoi": {"dataType":"boolean","required":true},
            "details": {"dataType":"array","array":{"dataType":"refObject","ref":"ValidationErrorItem"},"required":true},
            "_original": {"dataType":"any","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "ResultController_PageData_UserDTO_-or-ValidationError_": {
        "dataType": "refObject",
        "properties": {
            "status": {"dataType":"boolean","required":true},
            "reason": {"dataType":"string"},
            "data": {"dataType":"union","subSchemas":[{"ref":"PageData_UserDTO_"},{"ref":"ValidationError"}]},
    ...
    "GetUsersResponseDTO": {
        "dataType": "refAlias",
        "type": {"ref":"ResultController_PageData_UserDTO_-or-ValidationError_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "LoginUserToken": {
        "dataType": "refObject",
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/ping',
            ...
            async function PingController_handler(request: any, response: any, next: any) {
            const args = {
            };
        ...
        app.get('/api/users',
            ...
            async function GetUsersController_handler(request: any, response: any, next: any) {
            const args = {
                    filter: {"default":"","in":"query","name":"filter","dataType":"string"},
                    page: {"in":"query","name":"page","dataType":"double"},
                    pageSize: {"in":"query","name":"pageSize","dataType":"double"},
                    sortField: {"in":"query","name":"sortField","dataType":"string"},
                    sortDirection: {"in":"query","name":"sortDirection","dataType":"string"},
            };
        ...
        app.post('/api/users/login',
            ...
            async function LoginUserController_handler(request: any, response: any, next: any) {
            const args = {
